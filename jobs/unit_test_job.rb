...
SCHEDULER.every '10s', :first_in => 0 do |job|
  ...
  @doc = Nokogiri::XML(open("http://localhost/unit_tests.xml"))
  ...
  send_event('unit_test_data', { passed: passing, last_passed: last_passing,ignored: ignored, failed: failed_tests, not_run:0, duration:duration, status:status})
